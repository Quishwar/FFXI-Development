  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] w-[90vw] max-w-[400px] z-50 outline-none">
          <div className="ff-window bg-ui-window border border-red-900/50 p-6 shadow-2xl relative">
